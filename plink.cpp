...
int main(int argc, char* argv[]) 
{
  ...
  P.printLOG("\n"
	     "@------------------------------------------------------------------@\n"
	     "|       LAMPLINK!       |      v"+PVERSION+PREL+"      |      "+PDATE+"      |\n"
	     "|------------------------------------------------------------------|\n"
	     "|  (C) 2015 LAMP development team, GNU General Public License, v2  |\n"
	     "|------------------------------------------------------------------|\n"
         ...
         "|  http://a-terada.github.io/lamplink                              |\n"
         "@------------------------------------------------------------------@\n"
	     "\n");
  /*
  P.printLOG("\n"
